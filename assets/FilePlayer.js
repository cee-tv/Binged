import {g as b, r as _, u as O, p as A} from "./index.js?6cea0eca";
function R(s, e) {
...
var I = Object.create
  ...
  , E = (s,e,t,i)=>{
    if (e && typeof e == "object" || typeof e == "function")
        for (let n of w(e))
            !k.call(s, n) && n !== t && u(s, n, {
                get: ()=>e[n],
                enumerable: !(i = D(e, n)) || i.enumerable
            });
    return s
}
  , j = (s,e,t)=>(t = s != null ? I(M(s)) : {},
E(e || !s || !s.__esModule ? u(t, "default", {
    value: s,
    enumerable: !0
}) : t, s))
  , H = s=>E(u({}, "__esModule", {
  ...
  , r = (s,e,t)=>(U(s, typeof e != "symbol" ? e + "" : e, t),
t)
  , m = {};
N(m, {
    default: ()=>P
...
const y = typeof navigator < "u"
  ...
  , v = y && (/iPad|iPhone|iPod/.test(navigator.userAgent) || F) && !window.MSStream
  , V = y && /^((?!chrome|android).)*safari/i.test(navigator.userAgent) && !window.MSStream
  , T = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js?6cea0eca"
  , C = "Hls"
  , B = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js?6cea0eca"
  , x = "dashjs"
  , K = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js?6cea0eca"
  , G = "flvjs"
  , X = /www\.dropbox\.com\/.+/
...
class P extends c.Component {
    constructor() {
        ...
        r(this, "onPlayBackRateChange", e=>this.props.onPlaybackRateChange(e.target.playbackRate)),
        ...
        r(this, "onPresentationModeChange", e=>{
            if (this.player && (0,
            a.supportsWebKitPresentationMode)(this.player)) {
        ...
        r(this, "renderSourceElement", (e,t)=>typeof e == "string" ? c.default.createElement("source", {
            key: t,
            src: e
        ...
        r(this, "renderTrack", (e,t)=>c.default.createElement("track", {
            key: t,
            ...e
        })),
        r(this, "ref", e=>{
    ...
    componentDidUpdate(e) {
        ...
        a.isMediaStream)(this.props.url) && !(this.props.url instanceof Array) && (this.player.srcObject = null)
    }
    ...
    shouldUseHLS(e) {
        return V && this.props.config.forceSafariHLS || this.props.config.forceHLS ? !0 : v || this.props.config.forceDisableHls ? !1 : d.HLS_EXTENSIONS.test(e) || f.test(e)
    }
    shouldUseDASH(e) {
    ...
    load(e) {
        ...
        a.getSDK)(T.replace("VERSION", t), C).then(o=>{
            if (this.hls = new o(i),
        ...
        a.getSDK)(B.replace("VERSION", n), x).then(o=>{
            this.dash = o.MediaPlayer().create(),
            this.dash.initialize(this.player, e, this.props.playing),
            this.dash.on("error", this.props.onError),
            parseInt(n) < 3 ? this.dash.getDebug().setLogToBrowserConsole(!1) : this.dash.updateSettings({
                debug: {
        ...
        a.getSDK)(K.replace("VERSION", l), G).then(o=>{
    ...
    enablePIP() {
        ...
        a.supportsWebKitPresentationMode)(this.player) && this.player.webkitPresentationMode !== "picture-in-picture" && this.player.webkitSetPresentationMode("picture-in-picture")
    }
    disablePIP() {
        document.exitPictureInPicture && document.pictureInPictureElement === this.player ? document.exitPictureInPicture() : (0,
        a.supportsWebKitPresentationMode)(this.player) && this.player.webkitPresentationMode !== "inline" && this.player.webkitSetPresentationMode("inline")
    }
    setPlaybackRate(e) {
        try {
    ...
    getSource(e) {
        ...
        a.isMediaStream)(e) || t || i || n))
            return X.test(e) ? e.replace("www.dropbox.com", "dl.dropboxusercontent.com") : e
    }
    render() {
        const {url: e, playing: t, loop: i, controls: n, muted: l, config: o, width: h, height: p} = this.props
